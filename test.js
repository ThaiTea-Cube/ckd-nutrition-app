        // Bulletproof Failsafe Timer (starts immediately)
        const fallbackTimer = setTimeout(() => {
            ...
            const debugEl = document.getElementById('debug-email');
            if (debugEl) debugEl.textContent = '(Timeout/Error)';
        ...
        } // <-- Added missing closing brace for saveUserLimits()
